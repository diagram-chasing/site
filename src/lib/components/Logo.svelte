<script>
	// Import the logo image as specified
...
>
	...
	<text>
		<textPath
			...
			text-anchor="middle"
		>
			• THE DIAGRAM CHASERS OF BLR • EST 2024
		</textPath>
	</text>
</svg>

<style>
	/* Style the SVG to be responsive and scale proportionally */
	.logo-svg {
		height: auto;
		display: block; /* Removes extra space beneath the element */
